CLASS zcl_gn1266_tyt_table_type DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_GN1266_TYT_TABLE_TYPE IMPLEMENTATION.
...
*    DATA addresses TYPE tt_addresses.
    DATA addresses TYPE ZGN1266T_ADDRESSES.
...
*    DATA person TYPE st_person_deep.
    DATA person TYPE zgn1266s_person_deep.
...
*    DATA persons TYPE tt_persons.
    DATA persons TYPE ZGN1266T_PERSONS.
    persons =
       VALUE #(
          ( person )
          (
