CLASS zcl_gn1266_tyt_structure DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_GN1266_TYT_STRUCTURE IMPLEMENTATION.
...
*    DATA address TYPE st_address.
    DATA address TYPE zgn1266s_address.
...
*    DATA person TYPE st_person.
    DATA person TYPE zgn1266s_person.
...
*    DATA person2 TYPE st_person_inc.
    DATA person2 TYPE zgn1266s_PERSON_INC.
